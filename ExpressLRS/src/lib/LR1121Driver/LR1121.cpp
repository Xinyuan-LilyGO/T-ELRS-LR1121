...
void LR1121Driver::SetDioAsRfSwitch()
{
    ...
    {
        switchbuf[0] = 0b00000011; // RfswEnable
        switchbuf[1] = 0b00000000; // RfSwStbyCfg
        switchbuf[2] = 0b00000010; // RfSwRxCfg
        switchbuf[3] = 0b00000001; // RfSwTxCfg
        switchbuf[4] = 0b00000001; // RfSwTxHPCfg
        switchbuf[5] = 0b00000000; // RfSwTxHfCfg

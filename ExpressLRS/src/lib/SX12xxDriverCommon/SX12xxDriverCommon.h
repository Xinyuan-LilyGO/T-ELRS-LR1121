...
public:
    ...
    static bool ICACHE_RAM_ATTR nullCallbackRx(rx_status) {return false;}//ICACHE_RAM_ATTR:函数的代码存储在RAM中,提高执行速度
    ...
    WORD_ALIGNED_ATTR uint8_t RXdataBuffer[RXBuffSize];//WORD_ALIGNED_ATTR:地址对齐
    ...
    int8_t FuzzySNRThreshold; //信噪比阈值

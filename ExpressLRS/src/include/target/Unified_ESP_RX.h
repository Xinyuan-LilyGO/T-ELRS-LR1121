...
#define PE4259_1_PIN4 hardware_int(HARDWARE_pe4259_1_pin4)
#define PE4259_2_PIN4 hardware_int(HARDWARE_pe4259_2_pin4)

#define AT2401C_EN hardware_int(HARDWARE_at2401c_enable)
#define AT2401C_1_TXEN hardware_int(HARDWARE_at2401c_1_rxen)
#define AT2401C_1_RXEN hardware_int(HARDWARE_at2401c_1_txen)
#define AT2401C_2_TXEN hardware_int(HARDWARE_at2401c_2_rxen)
#define AT2401C_2_RXEN hardware_int(HARDWARE_at2401c_2_txen)
